...
insert  into `t_brand`(`brand_id`,`brand_name`,`brand_picture`) values (1,'aj','https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1576498522131&di=f6ea716c471a28240236ca0e63568feb&imgtype=0&src=http%3A%2F%2Fimg.zcool.cn%2Fcommunity%2F018e265cb927f8a801208f8b2dce2f.jpg%403000w_1l_2o_100sh.jpg');
...
insert  into `t_order`(`order_id`,`user_id`,`product_id`,`buy_num`,`total_price`,`address_id`,`create_time`,`pay_time`) values (1,1,1,1,1,1,'1','1');
